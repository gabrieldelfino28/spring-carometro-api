...
public record DadosListagemHistorico(Long id, String nomeEmpresa, String cargo, LocalDate dataContratacao, String dataDesligamento, String funcao, Long aluno) {
